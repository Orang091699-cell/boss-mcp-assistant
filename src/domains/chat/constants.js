...
export const CHAT_RESUME_FILE_ACCEPT_SELECTORS = Object.freeze([
  ".resume-file .btn-accept",
  ".resume-file-accept",
  '[class*="resume-file"][class*="accept"]',
  ".btn-accept-resume",
  ".chat-file-accept",
  '[class*="accept-resume"]',
  '[class*="file-accept"]'
...
export const CHAT_INTERN_PERIOD_KEYWORDS = Object.freeze([
  "实习周期", "实习时间", "实习时长", "实习期",
  "到岗时间", "最快到岗", "最快什么时候", "什么时候到岗",
  "几个月"
]);

export const CHAT_INTERN_START_KEYWORDS = Object.freeze([
  "到岗时间", "最快到岗", "什么时候到岗", "到岗日期",
  "开始实习", "入职时间", "入职日期"
]);
